...
=====================================================================
    ...
    - :help lua-guide
    - or `<leader>sh` then search `lua-guide` if you want to search the :help through telescope's fuzzy search
    - (or HTML version): https://neovim.io/doc/user/lua-guide.html

  TODO: Run the command `:Tutor` in Neovim if you need a quick refersher on how the hell you use this vim thing :)

    ALWAYS.READ.THE.HELP.WHEN.YOU.FEEL.LOST
    `:help` (without providing any other arguments)
    This will open up a help window with some basic information
    about reading, navigating and searching the builtin help documentation.

    The help should be the first place you go to look when you're stuck or confused
    with something. It's one of the best favorite Neovim features.

    MOST IMPORTANTLY, don't forget the telescope plugin's keymap "<space>sh" to [s]earch the [h]elp documentation,
    which is very useful when you're not exactly sure of what you're looking for and you want to "fuzzy search" a thing.

    There are several `:help X` comments throughout the init.lua
    These are hints about where to find more information about the relevant settings,
    plugins or Neovim features used in this config file.

   NOTE: Look for lines like this

If you experience any errors while trying to install this neovim configuration, run `:checkhealth` for more info.
...
--  So this will be the first thing that we ever config, so that it runs first before anything else.
vim.g.mapleader = ' '
...
-- Make line numbers in the gutter visible
vim.opt.number = true
...
-- Sync clipboard between OS and Neovim's registers.
...
-- vim.keymap lets us add functionality to our keystrokes, but vim.api will let us add functionality when particular are fired/triggered
-- by neovim, this is very similar to event listeners in javascript, but we call them autocommands in neovim, cause they automatically run
...
require('lazy').setup({
  ...
  { -- Highlight languages keywords, edit, and navigate code
